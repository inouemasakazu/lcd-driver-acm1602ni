...
LCD/if/%.o LCD/if/%.su LCD/if/%.cyclo: ../LCD/if/%.c LCD/if/subdir.mk
...
clean: clean-LCD-2f-if

clean-LCD-2f-if:
	-$(RM) ./LCD/if/if_lcd.cyclo ./LCD/if/if_lcd.d ./LCD/if/if_lcd.o ./LCD/if/if_lcd.su

.PHONY: clean-LCD-2f-if
